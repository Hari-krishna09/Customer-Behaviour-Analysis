...
-- Q6. Which S products have the highest percentage of purchases with discounts applied?
...
-- 08. What are the top 3 most purchased ptoducts within each category?
with item_counts as(
select category,
item_purchased,
...
-- 09. Are customers who are repeat buyers (rure than S previous purchases) also Likely to subscribe?
select subscription_status,
...
-- QI0. What is the revenue contribution ot each age group?
select age_group,
